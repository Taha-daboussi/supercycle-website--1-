  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-black">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-4">
        {/* Card container */}
        <div className="bg-[#1D1D1D]/80 backdrop-blur-s p-4 shadow-2xl rounded-[80px] w-[430px] h-[450px] flex flex-col justify-center items-center gap-2">
          {/* Header (centered) */}
          ...
          >
            <Image src="/x-logo.png" alt="X Logo" width={48} height={36} />
